...
define("EW_PROJECT_NAME", "rbping_server", TRUE); // Project name
define("EW_RANDOM_KEY", 'eYwPfWI9e5YiCGor', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/rbping_server.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_HOST", getenv("RBPING_DB_HOST") ?: "127.0.0.1", TRUE);
define("EW_CONN_PORT", getenv("RBPING_DB_PORT") ? intval(getenv("RBPING_DB_PORT")) : 3306, TRUE);
define("EW_CONN_USER", getenv("RBPING_DB_USER") ?: "rbping_master", TRUE);
define("EW_CONN_PASS", getenv("RBPING_DB_PASS") ?: "", TRUE);
define("EW_CONN_DB", getenv("RBPING_DB_NAME") ?: "rbping", TRUE);
