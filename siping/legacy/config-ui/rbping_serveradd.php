...
// Create page object
$rbping_server_add = new crbping_server_add();
$Page =& $rbping_server_add;

// Page init
$rbping_server_add->Page_Init();

// Page main
$rbping_server_add->Page_Main();
?>
...
// Create page object
var rbping_server_add = new ew_Page("rbping_server_add");

// page properties
rbping_server_add.PageID = "add"; // page ID
rbping_server_add.FormID = "frbping_serveradd"; // form ID
var EW_PAGE_ID = rbping_server_add.PageID; // for backward compatibility

// extend page with ValidateForm function
rbping_server_add.ValidateForm = function(fobj) {
...
rbping_server_add.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
rbping_server_add.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
	ew_ClickAll(elem);
}
<?php if (EW_CLIENT_VALIDATE) { ?>
rbping_server_add.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
rbping_server_add.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p class="phpmaker ewTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $rbping_server->TableCaption() ?></p>
<p class="phpmaker"><a href="<?php echo $rbping_server->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $rbping_server_add->ShowPageHeader(); ?>
<?php
$rbping_server_add->ShowMessage();
?>
<form name="frbping_serveradd" id="frbping_serveradd" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return rbping_server_add.ValidateForm(this);">
<p>
...
<?php
$rbping_server_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script language="JavaScript" type="text/javascript">
...
<?php
$rbping_server_add->Page_Terminate();
?>
<?php
...
class crbping_server_add {
	...
	// Page object name
	var $PageObjName = 'rbping_server_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			$rbping_server->CurrentAction = $_POST["a_add"]; // Get form action
			$this->CopyRecord = $this->LoadOldRecord(); // Load old recordset
			$this->LoadFormValues(); // Load form values

			// Validate form
			if (!$this->ValidateForm()) {
				$rbping_server->CurrentAction = "I"; // Form error, reset action
			...
			if ($this->CopyRecord) {
				$rbping_server->CurrentAction = "C"; // Copy record
			} else {
				$rbping_server->CurrentAction = "I"; // Display blank record
			...
			case "A": // ' Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "rbping_serverview.php")
						$sReturnUrl = $rbping_server->ViewUrl(); // View paging, return to view page with keyurl directly
		...
		$rbping_server->RowType = EW_ROWTYPE_ADD;  // Render add type
